...
/** The maximum size of a blk°Ë±¦?.dat file (since 0.8) */
static const unsigned int MAX_BLOCKFILE_SIZE = 0x8000000; // 128 MiB
/** The pre-allocation chunk size for blk°Ë±¦?.dat files (since 0.8) */
static const unsigned int BLOCKFILE_CHUNK_SIZE = 0x1000000; // 16 MiB
/** The pre-allocation chunk size for rev°Ë±¦?.dat files (since 0.8) */
...
/** Open a block file (blk°Ë±¦?.dat) */
FILE* OpenBlockFile(const CDiskBlockPos &pos, bool fReadOnly = false);
/** Open an undo file (rev°Ë±¦?.dat) */
