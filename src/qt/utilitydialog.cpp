    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bagcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Bagcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bagcoin Core is shutting down...") + "<br /><br />" +
