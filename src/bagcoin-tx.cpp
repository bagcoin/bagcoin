...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bagcoin Core bagcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bagcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bagcoin transaction") + "\n" +
              "  bagcoin-tx [options] -create [commands]   " + _("Create hex-encoded bagcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bagcoin transaction
