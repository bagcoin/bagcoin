...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Bagcoin features */
    { "bagcoin",               "spork",                  &spork,                  true,      false,      false },
    { "bagcoin",               "masternode",             &masternode,             true,      false,      true  },
    { "bagcoin",               "mnbudget",               &mnbudget,               true,      false,      false },
    { "bagcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      false,      false },
    { "bagcoin",               "masternodelist",         &masternodelist,         true,      false,      false },
#ifdef ENABLE_WALLET
    { "bagcoin",               "darksend",               &darksend,               false,     false,      true  },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use bagcoind, or the -server option to bagcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> bagcoin-cli " + methodname + " " + args + "\n";
}
