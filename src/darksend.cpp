    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Bagcoin and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun, bool ready)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeBagcoinAmount*COIN - pwalletMain->GetAnonymizedBalance();
