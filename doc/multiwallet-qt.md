...
Only requiring some minor changes is bagcoin.cpp.
...
Changes to bagcoin.cpp
----------------------
bagcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
