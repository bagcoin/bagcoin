...
1. Run bagcoin behind a Tor proxy
----------------------------------
...
port 9050 and only allows .onion nodes to connect:
	...
	./bagcoind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./bagcoind -proxy=127.0.0.1:9050


2. Run a bagcoin hidden server
-------------------------------
...
config file):
	...
	HiddenServiceDir /var/lib/tor/bagcoin-service/
	HiddenServicePort 9999 127.0.0.1:9999
	HiddenServicePort 19999 127.0.0.1:19999

The directory can be different of course, but (both) port numbers should be equal to
your bagcoind's P2P listen port (9999 by default).

	-externalip=X   You can tell bagcoin about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/bagcoin-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./bagcoind -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./bagcoind -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known bagcoin Tor relays
------------------------------------

* [bagcoinie7ghp67.onion](http://bagcoinie7ghp67.onion/)
